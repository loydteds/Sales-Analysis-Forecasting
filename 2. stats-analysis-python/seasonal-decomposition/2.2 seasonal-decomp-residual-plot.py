...
for sub_category in sub_categories:
    ...
    residual = decomposition.resid
      ...
      # Print the dates and their corresponding residual values
    print(f"\nResidual values for {sub_category}:")
    for date, value in residual.items():
        print(f"Date: {date.date()}, Residual Value: {value:.2f}")
    
    # Create a Plotly figure for the residual component
    fig = go.Figure()
